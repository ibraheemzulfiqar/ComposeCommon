package compose.common.ratingbar
...
internal fun RatingBar(
    ...
    painterEmpty: ((index: Int) -> Painter)? = null,
    painterFilled: ((index: Int) -> Painter)? = null,
    tint: Color? = null,
...
fun RatingBar(
    ...
    hideInactiveStars: Boolean = false,
    tint: Color? = null,
    painterEmpty: (index: Int) -> Painter,
    painterFilled: (index: Int) -> Painter,
    onValueChange: (Float) -> Unit,
    onRatingChanged: (Float) -> Unit
) {
    RatingBar(
        ...
        for (i in 1..numOfStars) {
            ...
            RatingStar(
                ...
                modifier = Modifier
                    ...
                    .size(size = size)
                    .testTag("RatingStar"),
                painterEmpty = painterEmpty?.invoke(i),
                painterFilled = painterFilled?.invoke(i),
                tint = tint,
            )
        }
    }
